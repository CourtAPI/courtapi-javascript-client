...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CourtApi.PACERQueryCaseAttorneysItemsInnerText();
  });
  ...
  describe('PACERQueryCaseAttorneysItemsInnerText', function() {
    it('should create an instance of PACERQueryCaseAttorneysItemsInnerText', function() {
      // uncomment below and update the code to test PACERQueryCaseAttorneysItemsInnerText
      //var instane = new CourtApi.PACERQueryCaseAttorneysItemsInnerText();
      //expect(instance).to.be.a(CourtApi.PACERQueryCaseAttorneysItemsInnerText);
    });
