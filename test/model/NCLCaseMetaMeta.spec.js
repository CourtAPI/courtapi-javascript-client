...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CourtApi.NCLCaseMetaMeta();
  });
  ...
  describe('NCLCaseMetaMeta', function() {
    it('should create an instance of NCLCaseMetaMeta', function() {
      // uncomment below and update the code to test NCLCaseMetaMeta
      //var instane = new CourtApi.NCLCaseMetaMeta();
      //expect(instance).to.be.a(CourtApi.NCLCaseMetaMeta);
    });
