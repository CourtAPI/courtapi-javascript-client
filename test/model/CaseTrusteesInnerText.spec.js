...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CourtApi.CaseTrusteesInnerText();
  });
  ...
  describe('CaseTrusteesInnerText', function() {
    it('should create an instance of CaseTrusteesInnerText', function() {
      // uncomment below and update the code to test CaseTrusteesInnerText
      //var instane = new CourtApi.CaseTrusteesInnerText();
      //expect(instance).to.be.a(CourtApi.CaseTrusteesInnerText);
    });
