...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CourtApi.CaseJudgesInnerText();
  });
  ...
  describe('CaseJudgesInnerText', function() {
    it('should create an instance of CaseJudgesInnerText', function() {
      // uncomment below and update the code to test CaseJudgesInnerText
      //var instane = new CourtApi.CaseJudgesInnerText();
      //expect(instance).to.be.a(CourtApi.CaseJudgesInnerText);
    });
