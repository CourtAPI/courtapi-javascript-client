...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CourtApi.InlineResponse20018Content();
  });
  ...
  describe('InlineResponse20018Content', function() {
    it('should create an instance of InlineResponse20018Content', function() {
      // uncomment below and update the code to test InlineResponse20018Content
      //var instane = new CourtApi.InlineResponse20018Content();
      //expect(instance).to.be.a(CourtApi.InlineResponse20018Content);
    });
