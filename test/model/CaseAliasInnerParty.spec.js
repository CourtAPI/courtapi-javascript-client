...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CourtApi.CaseAliasInnerParty();
  });
  ...
  describe('CaseAliasInnerParty', function() {
    it('should create an instance of CaseAliasInnerParty', function() {
      // uncomment below and update the code to test CaseAliasInnerParty
      //var instane = new CourtApi.CaseAliasInnerParty();
      //expect(instance).to.be.a(CourtApi.CaseAliasInnerParty);
    });
