...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CourtApi.CasePartiesInnerText();
  });
  ...
  describe('CasePartiesInnerText', function() {
    it('should create an instance of CasePartiesInnerText', function() {
      // uncomment below and update the code to test CasePartiesInnerText
      //var instane = new CourtApi.CasePartiesInnerText();
      //expect(instance).to.be.a(CourtApi.CasePartiesInnerText);
    });
