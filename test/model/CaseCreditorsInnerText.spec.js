...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CourtApi.CaseCreditorsInnerText();
  });
  ...
  describe('CaseCreditorsInnerText', function() {
    it('should create an instance of CaseCreditorsInnerText', function() {
      // uncomment below and update the code to test CaseCreditorsInnerText
      //var instane = new CourtApi.CaseCreditorsInnerText();
      //expect(instance).to.be.a(CourtApi.CaseCreditorsInnerText);
    });
