...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CourtApi.CaseAliasInnerText();
  });
  ...
  describe('CaseAliasInnerText', function() {
    it('should create an instance of CaseAliasInnerText', function() {
      // uncomment below and update the code to test CaseAliasInnerText
      //var instane = new CourtApi.CaseAliasInnerText();
      //expect(instance).to.be.a(CourtApi.CaseAliasInnerText);
    });
