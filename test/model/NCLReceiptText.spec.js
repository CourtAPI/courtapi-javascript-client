...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CourtApi.NCLReceiptText();
  });
  ...
  describe('NCLReceiptText', function() {
    it('should create an instance of NCLReceiptText', function() {
      // uncomment below and update the code to test NCLReceiptText
      //var instane = new CourtApi.NCLReceiptText();
      //expect(instance).to.be.a(CourtApi.NCLReceiptText);
    });
