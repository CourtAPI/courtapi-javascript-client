...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CourtApi.InlineResponse2007QueriesFilersText();
  });
  ...
  describe('InlineResponse2007QueriesFilersText', function() {
    it('should create an instance of InlineResponse2007QueriesFilersText', function() {
      // uncomment below and update the code to test InlineResponse2007QueriesFilersText
      //var instane = new CourtApi.InlineResponse2007QueriesFilersText();
      //expect(instance).to.be.a(CourtApi.InlineResponse2007QueriesFilersText);
    });
