...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CaseMeta', 'model/InlineResponse2003Items', 'model/InlineResponse2007Queries'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CaseMeta'), require('./InlineResponse2003Items'), require('./InlineResponse2007Queries'));
  } else {
    // Browser globals (root is window)
    if (!root.CourtApi) {
      root.CourtApi = {};
    }
    root.CourtApi.InlineResponse2007 = factory(root.CourtApi.ApiClient, root.CourtApi.CaseMeta, root.CourtApi.InlineResponse2003Items, root.CourtApi.InlineResponse2007Queries);
  }
}(this, function(ApiClient, CaseMeta, InlineResponse2003Items, InlineResponse2007Queries) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('queries')) {
        obj['queries'] = InlineResponse2007Queries.constructFromObject(data['queries']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/InlineResponse2007Queries} queries
   */
