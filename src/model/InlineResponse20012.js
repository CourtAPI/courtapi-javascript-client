...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CaseMeta', 'model/InlineResponse20012Queries', 'model/InlineResponse2003Items'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CaseMeta'), require('./InlineResponse20012Queries'), require('./InlineResponse2003Items'));
  } else {
    // Browser globals (root is window)
    if (!root.CourtApi) {
      root.CourtApi = {};
    }
    root.CourtApi.InlineResponse20012 = factory(root.CourtApi.ApiClient, root.CourtApi.CaseMeta, root.CourtApi.InlineResponse20012Queries, root.CourtApi.InlineResponse2003Items);
  }
}(this, function(ApiClient, CaseMeta, InlineResponse20012Queries, InlineResponse2003Items) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('queries')) {
        obj['queries'] = InlineResponse20012Queries.constructFromObject(data['queries']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/InlineResponse20012Queries} queries
   */
