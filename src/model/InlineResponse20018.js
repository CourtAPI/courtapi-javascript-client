...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20018Content'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse20018Content'));
  } else {
    // Browser globals (root is window)
    if (!root.CourtApi) {
      root.CourtApi = {};
    }
    root.CourtApi.InlineResponse20018 = factory(root.CourtApi.ApiClient, root.CourtApi.InlineResponse20018Content);
  }
}(this, function(ApiClient, InlineResponse20018Content) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = InlineResponse20018Content.constructFromObject(data['content']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/InlineResponse20018Content} content
   */
